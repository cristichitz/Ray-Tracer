...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/12 18:52:26 by cdohanic          #+#    #+#             */
/*   Updated: 2026/06/12 18:52:28 by cdohanic         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Rotate one quad `ang` radians about `axis` through `pivot`, then rebuild
** the cached plane fields the kernel reads (normal, d, w).
*/
...
/*
** Rotate every quad of every cubie in the active slice by `ang`. A cubie is
** in the slice when its grid coordinate on the move axis equals the layer.
*/
...
/*
** After an animated turn finishes, advance the integer grid coordinates of
** the moved cubies by the exact 90-degree permutation the turn implies.
** Reusing rot_vec_axis with (cos, sin) = (0, +/-1) keeps it in lockstep with
** the geometry, so positions never drift.
*/
