...
typedef struct s_texture {
  t_vec3  (*value)(struct s_texture *self, float u, float v, t_vec3 p);
  t_vec3  albedo;
} t_texture;
...
typedef struct s_material {
  t_texture  tex;
  bool    (*scatter)(t_material *self, t_ray r_in, t_hit_record rec, t_vec3 *attenuation, t_ray *scattered);
  t_vec3  (*emmited)(t_material *self, float u, float v, t_vec3 p);
} t_material;
